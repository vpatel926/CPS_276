...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'vpatel5';//this will be your WCC username
      $dbUsr = 'vpatel5';//this will be your WCC username
      $dbPass = 'wG45SY65YErW';//this will be the password found in the video.
